...
public class CartJpaTest extends JpaTest {

    public static Cart getInitEntity() {
    	Cart entity = new Cart();
		// cartId is auto-incremented => do not set
    ...
    private Object getEntityKey(Cart entity) {
